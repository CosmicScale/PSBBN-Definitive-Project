...
```
git clone --branch PSBBN-Definitive-Project-v4.2 https://github.com/CosmicScale/PSBBN-Definitive-Project.git
```
...
Download the PSBBN Launcher for Windows [here](https://raw.githubusercontent.com/CosmicScale/PSBBN-Definitive-Project/refs/heads/PSBBN-Definitive-Project-v4.2/scripts/PSBBN-Launcher-For-Windows.ps1) (Right-click and select Save link as).
